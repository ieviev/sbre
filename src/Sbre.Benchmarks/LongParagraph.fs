module Sbre.Benchmarks.LongParagraph
...
[<BenchmarkDotNet.Attributes.MemoryDiagnoser>]
[<ShortRunJob>]
type LongParagraph9000_10() =
    do AppContext.SetData("REGEX_NONBACKTRACKING_MAX_AUTOMATA_SIZE", 1_000_000)

    let pat_lookaround = permuteWithLookaround words[..9]
