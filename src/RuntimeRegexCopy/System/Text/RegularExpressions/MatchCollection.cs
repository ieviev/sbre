...
namespace System.Text.RuntimeRegexCopy
{
    ...
    public class MatchCollection : IList<Match>, IReadOnlyList<Match>, IList
    {
        ...
        Match IList<Match>.this[int index] { get => this[index]; set => throw new NotSupportedException(SR.NotSupported_ReadOnlyCollection); }
        ...
        int IList.IndexOf(object? value) => value is Match other ? ((IList<Match>)this).IndexOf(other) : -1;
