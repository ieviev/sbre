...
namespace System.Text.RuntimeRegexCopy
{
    ...
    public class Match : Group
    {
        ...
        internal Match(Regex? regex, int capcount, string? text, int textLength) : base(text, new int[2], 0, "0")
        {
            _regex = regex;
        ...
        public void Reset(string? text, int textLength)
        {
            Text = text;
            _textbeg = 0;
            _textend = textLength;
        ...
        /// </remarks>
        public bool FoundMatch => _matchcount[0] > 0;
        ...
        public Match NextMatch()
        {
            ...
            return r != null ? r.RunSingleMatch(RegexRunnerMode.FullMatchRequired, Length, Text, _textbeg, _textend - _textbeg, _textpos)! : this;
        }
        ...
        public ReadOnlyMemory<char> GroupToStringImpl(int groupnum)
        {
        ...
        public ReadOnlyMemory<char> LastGroupToStringImpl() => GroupToStringImpl(_matchcount.Length - 1);
        /// <summary>
        ...
        public void RemoveMatch(int cap) => _matchcount[cap]--;
        /// <summary>Tells if a group was matched by capnum</summary>
        public bool IsMatched(int cap)
        {
            int[] matchcount = _matchcount;
        ...
        public void Tidy(int textpos, int beginningOfSpanSlice, RegexRunnerMode mode)
        {
    ...
    /// </summary>
    public sealed class MatchSparse : Match
    {
        private new readonly Hashtable _caps;
        internal MatchSparse(Regex regex, Hashtable caps, int capcount, string? text, int textLength) : base(regex, capcount, text, textLength)
        {
            _caps = caps;
        }
