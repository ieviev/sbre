...
namespace System.Text.RuntimeRegexCopy
{
 ...
 s_cacheDictionary.TryGetValue(key, out Node? node))
        ...
        public readonly struct Key : IEquatable<Key>
        {
            ...
            public bool Equals(Key other) => _pattern.Equals(other._pattern) && _culture.Equals(other._culture) && _options == other._options && _matchTimeout == other._matchTimeout;
            public override int GetHashCode() => // Hash code only factors in pattern and options, as regex instances are unlikely to have
