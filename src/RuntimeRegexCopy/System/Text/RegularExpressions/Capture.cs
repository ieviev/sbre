...
namespace System.Text.RuntimeRegexCopy
{
    ...
    public class Capture
    {
        ...
        public ReadOnlyMemory<char> GetLeftSubstring() => Text is string text ? text.AsMemory(0, Index) : ReadOnlyMemory<char>.Empty;
        /// <summary>The substring to the right of the capture</summary>
        public ReadOnlyMemory<char> GetRightSubstring() => Text is string text ? text.AsMemory(Index + Length, Text.Length - Index - Length) : ReadOnlyMemory<char>.Empty;
    }
}