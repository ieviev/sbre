...
{
    public sealed class CompiledRegexRunnerFactory : RegexRunnerFactory
    {
        ...
        protected internal override RegexRunner CreateInstance() => new CompiledRegexRunner(_scan ??= _scanMethod.CreateDelegate<CompiledRegexRunner.ScanDelegate>(), _culture);
    }
}