...
namespace System.Text.RuntimeRegexCopy
{
    ...
    public class CaptureCollection : IList<Capture>, IReadOnlyList<Capture>, IList
    {
        ...
        Capture IList<Capture>.this[int index] { get => this[index]; set => throw new NotSupportedException(SR.NotSupported_ReadOnlyCollection); }
        ...
        bool IList.Contains(object? value) => value is Capture other && ((ICollection<Capture>)this).Contains(other);
        int IList.IndexOf(object? value) => value is Capture other ? ((IList<Capture>)this).IndexOf(other) : -1;
