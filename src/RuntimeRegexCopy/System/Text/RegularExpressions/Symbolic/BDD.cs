...
namespace System.Text.RuntimeRegexCopy.Symbolic
{
    ...
    /// </remarks>
    public sealed class BDD : IComparable, IComparable<BDD>, IEquatable<BDD>
    {
        /// <summary>
        ...
        public int CompareTo(object? other)
        {
            ...
            var otherbdd = (BDD)other;
            if (IsLeaf)
            {
                return !otherbdd.IsLeaf || Ordinal < otherbdd.Ordinal ? -1 : Ordinal == otherbdd.Ordinal ? 0 : 1;
            }
            ...
            ulong min = GetMin();
            ulong bdd_min = otherbdd.GetMin();
            return min < bdd_min ? -1 : bdd_min < min ? 1 : Ordinal.CompareTo(otherbdd.Ordinal);
        }
...
#region Serialization
        ...
        public int CompareTo(BDD? other)
        {
            ...
            if (IsLeaf)
            {
                return !other.IsLeaf || Ordinal < other.Ordinal ? -1 : Ordinal == other.Ordinal ? 0 : 1;
            }
            ...
            return min < bdd_min ? -1 : bdd_min < min ? 1 : Ordinal.CompareTo(other.Ordinal);
        }
    }
}