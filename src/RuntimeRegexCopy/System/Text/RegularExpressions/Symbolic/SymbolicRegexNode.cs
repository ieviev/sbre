...
namespace System.Text.RegularExpressions.Symbolic
{
        ...
        where TSet : IComparable<TSet>, IEquatable<TSet>
    {
        ...
        public bool IsLazy => _info.IsLazyLoop;
        /// <summary>True if this node is high priority nullable</summary>
        public bool IsHighPriorityNullable => _info.IsHighPriorityNullable;
        /// <summary>True if this node is high priority nullable for the given context</summary>
        public bool IsHighPriorityNullableFor(uint context) => _info.CanBeNullable && IsHighPriorityNullableFor(this, context);
            ...
            while (true)
            {
                ...
                switch (node._kind)
                {
                    ...
                    default:
                        ...
                        Debug.Assert(node._kind is SymbolicRegexNodeKind.BeginningAnchor or SymbolicRegexNodeKind.EndAnchor or SymbolicRegexNodeKind.BOLAnchor or SymbolicRegexNodeKind.EOLAnchor or SymbolicRegexNodeKind.BoundaryAnchor or SymbolicRegexNodeKind.NonBoundaryAnchor or SymbolicRegexNodeKind.EndAnchorZ or SymbolicRegexNodeKind.EndAnchorZReverse);
        ...
        public bool IsNullable => _info.IsNullable;
        ...
        public bool IsNullableFor(uint context)
        {
            ...
            return _nullabilityCache is null ? _info.IsNullable : WithCache(context);
        ...
        public SymbolicRegexNodeKind Kind => _kind;
        /// <summary>
...
#region called only once, in the constructor of SymbolicRegexBuilder
        public static SymbolicRegexNode<TSet> CreateFalse(SymbolicRegexBuilder<TSet> builder) => Create(builder, SymbolicRegexNodeKind.Singleton, null, null, -1, -1, builder._solver.Empty, default);
        public static SymbolicRegexNode<TSet> CreateTrue(SymbolicRegexBuilder<TSet> builder) => Create(builder, SymbolicRegexNodeKind.Singleton, null, null, -1, -1, builder._solver.Full, default);
        public static SymbolicRegexNode<TSet> CreateFixedLengthMarker(SymbolicRegexBuilder<TSet> builder, int length) => Create(builder, SymbolicRegexNodeKind.FixedLengthMarker, null, null, length, -1, default, SymbolicRegexInfo.Epsilon());
        public static SymbolicRegexNode<TSet> CreateEpsilon(SymbolicRegexBuilder<TSet> builder) => Create(builder, SymbolicRegexNodeKind.Epsilon, null, null, -1, -1, default, SymbolicRegexInfo.Epsilon());
        public static SymbolicRegexNode<TSet> CreateAnchor(SymbolicRegexBuilder<TSet> builder, SymbolicRegexNodeKind kind)
        {
            Debug.Assert(kind is SymbolicRegexNodeKind.BoundaryAnchor or SymbolicRegexNodeKind.NonBoundaryAnchor or SymbolicRegexNodeKind.BeginningAnchor or SymbolicRegexNodeKind.EndAnchor or SymbolicRegexNodeKind.EndAnchorZ or SymbolicRegexNodeKind.EndAnchorZReverse or SymbolicRegexNodeKind.EOLAnchor or SymbolicRegexNodeKind.BOLAnchor);
            return Create(builder, kind, null, null, -1, -1, default, SymbolicRegexInfo.Anchor(isLineAnchor: kind is SymbolicRegexNodeKind.EndAnchorZ or SymbolicRegexNodeKind.EndAnchorZReverse or SymbolicRegexNodeKind.EOLAnchor or SymbolicRegexNodeKind.BOLAnchor));
        }

#endregion
        public static SymbolicRegexNode<TSet> CreateSingleton(SymbolicRegexBuilder<TSet> builder, TSet set) => Create(builder, SymbolicRegexNodeKind.Singleton, null, null, -1, -1, set, default);
        public static SymbolicRegexNode<TSet> CreateLoop(SymbolicRegexBuilder<TSet> builder, SymbolicRegexNode<TSet> body, int lower, int upper, bool isLazy)
        {
        ...
        public static SymbolicRegexNode<TSet> CreateEffect(SymbolicRegexBuilder<TSet> builder, SymbolicRegexNode<TSet> node, SymbolicRegexNode<TSet> effectNode)
        {
        ...
        public static SymbolicRegexNode<TSet> CreateCaptureStart(SymbolicRegexBuilder<TSet> builder, int captureNum) => Create(builder, SymbolicRegexNodeKind.CaptureStart, null, null, captureNum, -1, default, SymbolicRegexInfo.Epsilon());
        public static SymbolicRegexNode<TSet> CreateCaptureEnd(SymbolicRegexBuilder<TSet> builder, int captureNum) => Create(builder, SymbolicRegexNodeKind.CaptureEnd, null, null, captureNum, -1, default, SymbolicRegexInfo.Epsilon());
        public static SymbolicRegexNode<TSet> CreateDisableBacktrackingSimulation(SymbolicRegexBuilder<TSet> builder, SymbolicRegexNode<TSet> child) => Create(builder, SymbolicRegexNodeKind.DisableBacktrackingSimulation, child, null, -1, -1, default, child._info);
        /// <summary>Make a concatenation of the supplied regex nodes.</summary>
        public static SymbolicRegexNode<TSet> CreateConcat(SymbolicRegexBuilder<TSet> builder, SymbolicRegexNode<TSet> left, SymbolicRegexNode<TSet> right)
        {
        ...
        /// <returns></returns>
        public static SymbolicRegexNode<TSet> CreateAlternate(SymbolicRegexBuilder<TSet> builder, SymbolicRegexNode<TSet> left, SymbolicRegexNode<TSet> right, bool deduplicated = false, bool hintRightLikelySubsumes = false)
        {
        ...
        /// <returns></returns>
        public bool Subsumes(SymbolicRegexBuilder<TSet> builder, SymbolicRegexNode<TSet> other, int depth = 0)
        {
        ...
        public SymbolicRegexNode<TSet> AddFixedLengthMarkers(SymbolicRegexBuilder<TSet> builder, int lengthSoFar = 0)
        {
            ...
            return thisLength < 0 ? this : CreateConcat(builder, this, CreateFixedLengthMarker(builder, lengthSoFar + thisLength));
        }
        ...
        public SymbolicRegexNode<TSet> CreateDerivativeWithoutEffects(SymbolicRegexBuilder<TSet> builder, TSet elem, uint context) => CreateDerivativeWrapper(builder, elem, context).StripEffects(builder);
        /// <summary>
        /// Create a derivative (<see cref = "CreateDerivative(SymbolicRegexBuilder{TSet}, TSet, uint)"/> and <see cref = "CreateDerivativeWrapper"/>) and then strip
        ...
        /// <param name = "context">immediately surrounding character context that affects nullability of anchors</param>
        /// <returns>the derivative</returns>
        public List<(SymbolicRegexNode<TSet>, DerivativeEffect[])> CreateNfaDerivativeWithEffects(SymbolicRegexBuilder<TSet> builder, TSet elem, uint context)
        {
        ...
        private SymbolicRegexNode<TSet> PruneLowerPriorityThanNullability(SymbolicRegexBuilder<TSet> builder, uint context)
        {
            ...
            switch (_kind)
            {
                case SymbolicRegexNodeKind.Alternate:
                    ...
                    prunedNode = _left.IsNullableFor(context) ? _left.PruneLowerPriorityThanNullability(builder, context) : CreateAlternate(builder, _left, _right.PruneLowerPriorityThanNullability(builder, context), deduplicated: true);
                    break;
                case SymbolicRegexNodeKind.Concat:
                    Debug.Assert(_left is not null && _right is not null);
                    ...
                    prunedNode = _left._kind == SymbolicRegexNodeKind.Alternate ? (_left._left!.IsNullableFor(context) ? CreateConcat(builder, _left._left, _right).PruneLowerPriorityThanNullability(builder, context) : CreateAlternate(builder, CreateConcat(builder, _left._left, _right), CreateConcat(builder, _left._right!, _right).PruneLowerPriorityThanNullability(builder, context))) : CreateConcat(builder, _left.PruneLowerPriorityThanNullability(builder, context), _right.PruneLowerPriorityThanNullability(builder, context));
                    break;
                case SymbolicRegexNodeKind.Loop:
                    Debug.Assert(_left is not null);
                    // Lazy nullable loop reduces to (), i.e., the loop body is just forgotten
                    prunedNode = _info.IsLazyLoop && _lower == 0 ? builder.Epsilon : CreateLoop(builder, _left.PruneLowerPriorityThanNullability(builder, context), _lower, _upper, _info.IsLazyLoop);
                    break;
                case SymbolicRegexNodeKind.Effect:
            ...
            switch (_kind)
            {
                ...
                case SymbolicRegexNodeKind.Concat:
                {
                    ...
                    else
                    {
                        ...
                        derivative = _left.IsHighPriorityNullableFor(context) ? CreateAlternate(builder, rightDerivative, leftDerivative, hintRightLikelySubsumes: true) : CreateAlternate(builder, leftDerivative, rightDerivative);
                    }
        ...
        public SymbolicRegexNode<TSet> StripEffects(SymbolicRegexBuilder<TSet> builder)
        {
            if (!StackHelper.TryEnsureSufficientExecutionStack())
            {
        ...
        public void StripAndMapEffects(SymbolicRegexBuilder<TSet> builder, uint context, List<(SymbolicRegexNode<TSet>, DerivativeEffect[])> alternativesAndEffects, List<DerivativeEffect>? currentEffects = null)
        {
            if (!StackHelper.TryEnsureSufficientExecutionStack())
            {
        ...
        public void ApplyEffects<TArg>(Action<DerivativeEffect, TArg> apply, uint context, TArg arg)
        {
            if (!StackHelper.TryEnsureSufficientExecutionStack())
            {
        ...
        public bool StartsWithLoop(int upperBoundLowestValue = 1)
        {
            if (!StackHelper.TryEnsureSufficientExecutionStack())
            {
        ...
        public SymbolicRegexNode<TSet> PruneAnchors(SymbolicRegexBuilder<TSet> builder, uint prevKind)
        {
        ...
        private SymbolicRegexNode<TSet> PruneAnchorsImpl(SymbolicRegexBuilder<TSet> builder, uint prevKind, bool contWithWL, bool contWithNWL)
        {
            ...
            {
                case SymbolicRegexNodeKind.BeginningAnchor:
                    return prevKind == CharKind.BeginningEnd ? this : builder._nothing; //start anchor is only nullable if the previous character is Start
                case SymbolicRegexNodeKind.EndAnchorZReverse:
                    return ((prevKind & CharKind.BeginningEnd) != 0) ? this : builder._nothing; //rev(\Z) is only nullable if the previous characters is Start or the very first \n
                case SymbolicRegexNodeKind.BoundaryAnchor:
                    return (prevKind == CharKind.WordLetter ? contWithNWL : contWithWL) ? this : // \b is impossible when the previous character is \w but no continuation matches \W
 // or the previous character is \W but no continuation matches \w
                    builder._nothing;
                case SymbolicRegexNodeKind.NonBoundaryAnchor:
                    return (prevKind == CharKind.WordLetter ? contWithWL : contWithNWL) ? this : // \B is impossible when the previous character is \w but no continuation matches \w
 // or the previous character is \W but no continuation matches \W
                    builder._nothing;
                case SymbolicRegexNodeKind.Loop:
                    Debug.Assert(_left is not null);
                    SymbolicRegexNode<TSet> body = _left.PruneAnchorsImpl(builder, prevKind, contWithWL, contWithNWL);
                    return body == _left ? this : CreateLoop(builder, body, _lower, _upper, IsLazy);
                case SymbolicRegexNodeKind.Concat:
                {
                    Debug.Assert(_left is not null && _right is not null);
                    ...
                    return left1 == _left && right1 == _right ? this : CreateConcat(builder, left1, right1);
                }
                ...
                case SymbolicRegexNodeKind.Alternate:
                {
                    ...
                    Debug.Assert(left1 is not null && right1 is not null);
                    return left1 == _left && right1 == _right ? this : CreateAlternate(builder, left1, right1);
                }
                ...
                case SymbolicRegexNodeKind.Effect:
                {
                    Debug.Assert(_left is not null && _right is not null);
                    SymbolicRegexNode<TSet> left1 = _left.PruneAnchorsImpl(builder, prevKind, contWithWL, contWithNWL);
                    return left1 == _left ? this : CreateEffect(builder, left1, _right);
                }

                case SymbolicRegexNodeKind.DisableBacktrackingSimulation:
                    Debug.Assert(_left is not null);
                    SymbolicRegexNode<TSet> child = _left.PruneAnchorsImpl(builder, prevKind, contWithWL, contWithNWL);
                    return child == _left ? this : builder.CreateDisableBacktrackingSimulation(child);
                default:
                    return this;
            }
        }
        ...
        public int ResolveFixedLength(uint context)
        {
        ...
        public IEnumerable<SymbolicRegexNode<TSet>> EnumerateAlternationBranches(SymbolicRegexBuilder<TSet> builder)
        {
            switch (_kind)
            {
                case SymbolicRegexNodeKind.DisableBacktrackingSimulation:
        ...
        /// </summary>
        public int EstimateNfaSize() => Times(_info.ContainsSomeAnchor ? CharKind.CharKindCount : 1, Sum(1, CountSingletons()));
        /// <summary>
