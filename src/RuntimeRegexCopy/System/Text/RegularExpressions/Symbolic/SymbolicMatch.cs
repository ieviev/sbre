...
{
    public readonly struct SymbolicMatch
    {
        /// <summary>Indicates failure to find a match.</summary>
        public static SymbolicMatch NoMatch => new SymbolicMatch(-1, -1);
        /// <summary>Indicates a match was found but without meaningful details about where.</summary>
        public static SymbolicMatch MatchExists => new SymbolicMatch(0, 0);
