...
namespace System.Text.RegularExpressions.Symbolic
{
    ...
    /// </summary>
    public static class SymbolicRegexThresholds
    {
        ...
        /// </remarks>
        public static int GetSymbolicRegexSafeSizeThreshold()
        {
            object? safeSizeThreshold = AppContext.GetData(SymbolicRegexSafeSizeThreshold_ConfigKeyName);
            return (safeSizeThreshold is not int safeSizeThresholdInt || safeSizeThresholdInt <= 0) ? DefaultSymbolicRegexSafeSizeThreshold : safeSizeThresholdInt;
        }
    }
}