...
namespace System.Text.RegularExpressions.Symbolic
{
    ...
    {
        public static bool IsInitial(this StateFlags info) => (info & StateFlags.IsInitialFlag) != 0;
        public static bool IsDeadend(this StateFlags info) => (info & StateFlags.IsDeadendFlag) != 0;
        public static bool IsNullable(this StateFlags info) => (info & StateFlags.IsNullableFlag) != 0;
        public static bool CanBeNullable(this StateFlags info) => (info & StateFlags.CanBeNullableFlag) != 0;
        public static bool SimulatesBacktracking(this StateFlags info) => (info & StateFlags.SimulatesBacktrackingFlag) != 0;
    }
}