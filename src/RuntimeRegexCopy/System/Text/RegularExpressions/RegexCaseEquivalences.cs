...
namespace System.Text.RuntimeRegexCopy
{
    ...
    /// </summary>
    public static partial class RegexCaseEquivalences
    {
        public const int CharactersPerRange = 1024;
        private static readonly char[] s_specialCasingSetBehaviors = new char[5]{'I', 'i', '\u0130', 'I', '\u0131'};
        /// <summary>
        ...
        {
            return culture.Name.Length == 0 ? RegexCaseBehavior.Invariant : IsTurkishOrAzeri(culture.Name) ? RegexCaseBehavior.Turkish : RegexCaseBehavior.NonTurkish;
