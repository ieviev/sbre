    ...
    public partial class Regex
    {
        ...
        private static TimeSpan InitDefaultMatchTimeout()
        {
            ...
            if (defaultTimeout is not TimeSpan defaultMatchTimeOut)
            {
                ...
                throw new InvalidCastException(String.Format(SR.IllegalDefaultRegexMatchTimeoutInAppDomain, DefaultMatchTimeout_ConfigKeyName, defaultTimeout));
            }
            ...
            {
                throw new ArgumentOutOfRangeException(String.Format(SR.IllegalDefaultRegexMatchTimeoutInAppDomain, DefaultMatchTimeout_ConfigKeyName, defaultMatchTimeOut));
            }
